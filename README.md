...
React Native for both Android and iOS app

## 安裝 react-native-speech-iflytek
...
2. 替换 SDK 文件：
   ...
   1. 使用下载的 Android SDK 的 `Android_voice_xxxx_xxxxxxxx/libs` 文件夹中的所有文件替换 `Example/node_modules/react-native-speech-iflytek/android/libs` 文件夹的部分文件；
...
- `onRecognizerError(JSON error)`
  ...
  - `errorCode`: 获取错误码，关于错误码请见官方文档 [MSC 错误码](http://www.xfyun.cn/index.php/default/doccenter/doccenterInner?itemTitle=ZmFx&anchor=Y29udGl0bGU2Ng==) ：
...
```javascript
import com.iflytek.cloud.SpeechSynthesizer.setParameter on a null object
```
